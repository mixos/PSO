...
public class InitClustering {
	...
	public static void main(String[] args) throws Exception {		
		...
		System.out.println("PSO Clustering Started at: "+dateFormat.format(cal.getTime()));
		...
		System.out.println("PSO Clustering finished at: "+dateFormat.format(cal.getTime()));
